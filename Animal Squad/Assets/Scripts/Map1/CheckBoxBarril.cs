...
public class CheckBoxBarril : NetworkBehaviour
{
    [SerializeField] private Mission1 _Mission;

    [Header("Barris")]
    [SerializeField] private GameObject _Barril1;
    [SerializeField] private bool _Barril1Destroy = false;
    ...
    {
        if (_Barril1 == null && _Barril1Destroy == false)
        {
            _Barril1Destroy = true;
            _Mission._Carrinha--;
